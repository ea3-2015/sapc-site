<body style="background:#fff;">
    ...
    <?php
    echo $this->Html->script(array('jssor'));
    echo $this->Html->script(array('jssor.slider'));
    ...
    <div id="slider2_container" style="position: relative; top: 0px; left: 0px; width: 800px;
        ...
        <style>
          .foto{
            ...
            box-shadow: 2px 2px 53px #000;
          }

        </style>
        <!-- Slides Container -->
        <div u="slides" class="foto">
            <div>
                <a u=image href="#">
                  <!--<img src="../img/landscape/01.jpg" />-->
                  <?php echo $this->Html->image('foto1.jpg')?>
                </a>
            </div>
            <div>
                <a u=image href="#">
                  <!-- <img src="../img/landscape/02.jpg" /> -->
                  <?php echo $this->Html->image('foto2.jpg')?>
                </a>
            </div>
            <div>
                <a u=image href="#">
                  <!-- <img src="../img/landscape/03.jpg" /> -->
                  <?php echo $this->Html->image('foto3.jpg')?>
                </a>
            </div>
            <!-- <div>
